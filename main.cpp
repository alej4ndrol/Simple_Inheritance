...
int main(){
	...
	cout << Artem.Master::get_age() << endl;//при множественном наследовании мы получили алмаз при котором имеются одинаково определенные методы у двух родителей(магистр и учитель) которые являются потомками одного(человек) класса
	return 0;
}
